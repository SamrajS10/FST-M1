--Activity11
-- Records to display name and number of each salesman and each customer with more than one current order. Put the results in alphabetical order
...
-- Records to diplay which salesman produce the largest and smallest orders on each date.
